...
class Artiste(models.Model):
    ...
    image = models.ImageField(
        upload_to="static/media/artistes/", default="static/media/artistes/default.jpg"
    )
...
class ConfigurationFestival(models.Model):
    ...
    logo = models.ImageField(
        upload_to="static/media/configuration/logo/", default="static/media/default.jpg"
    )
...
class Scene(models.Model):
    nom = models.CharField(max_length=200)
    image = models.ImageField(
        upload_to="static/media/scenes/", default="static/media/scenes/default.jpg"
    )
